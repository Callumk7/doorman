defmodule Auth.Tenant.Manager do
  ...
  def activate_tenant(tenant_id) do
    case Auth.Database.Repo.get_tenant_by_id(tenant_id)
  ...
  def suspend_tenant(tenant_id, reason \\ nil) do
    Auth.Database.Repo.get_tenant_by_id(tenant_id)
    |> Ecto.Changeset.change(%{
      status: :suspended,
  ...
  defp start_tenant_server(tenant) do
    Auth.Tenant.Supervisor.start_tenant(tenant)
  end
end
